    ...
    <SafeAreaView style={styles.safe} edges={["top"]}>
      ...
      <View style={styles.body}>
        <View style={styles.card}>
          ...
          <Text style={styles.value}>{user?.role === "admin" ? "Amministratore" : "Operaio"}</Text>
        </View>
        ...
        {!confirming ? (
          ...
          <View style={styles.confirmBox}>
            <Text style={styles.confirmText}>Sei sicuro di voler uscire?</Text>
...
const styles = StyleSheet.create({
  ...
  logoutBtn: {
    marginTop: spacing.lg, borderWidth: 2, borderColor: colors.stopped, paddingVertical: 16,
    alignItems: "center",
  },
